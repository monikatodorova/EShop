...
namespace EShop.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Products/AddToShoppingCart
        public IActionResult AddProductToCartAsync(Guid? id)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult AddProductToCart([Bind("SelectedProductId", "Quantity")] AddToShoppingCartDto item)
        {
